              ...
              <div class="row mt-3">
                <div class="col-md-3 mb-3">
                  @if($booking->service_request->pet->photos)
                    <img src="{{ $booking->service_request->pet->photos->getUrl('preview') }}" width="100%">
                  @else
                    <img src="{{ asset('/assets/images/User.png') }}" class="pet-image" data-id="{{ $serviceRequest->pet->id }}" id="pet-img-{{ $serviceRequest->pet->id }}" style="filter: grayscale(100%);">
                  @endif
                </div>
                <div class="col-md-9">
                      ...
                      <p>
                        ...
                        @else
                          ...
                          <!--add review modal link -->
                            <a href="" class="btn btn-sm btn-default" data-toggle="modal" data-target="#reviewModal" data-booking-id="{{ $booking->id }}">Submit a review </a>
