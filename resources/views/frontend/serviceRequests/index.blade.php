                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('frontend.service-requests.index') }}" method="GET" class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-md btn-primary" style="max-height:">{{ __('Search') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p>
                                                ...
                                                @elseif($serviceRequest->pending==2 && $serviceRequest->closed==1)  
                                                <a href="" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#reviewModal" data-booking-id="{{ $booking->id }}">Review</a>
                                                ...
                                                @if(\Carbon\Carbon::parse($serviceRequest->to)->timezone(Auth::user()->timezone) < $today && $serviceRequest->decline == 0 && $serviceRequest->closed == 0 && $serviceRequest->pending == 0)
                                                   ...
                                                   <a href="{{ route('frontend.service-requests.edit', $serviceRequest->id) }}" class="btn btn-info btn-sm"><span> Expired </span> &nbsp;<i class="fas fa-edit"></i></a>
                                                @endif
