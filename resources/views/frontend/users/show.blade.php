                ...
                <div class="mbr-section-text mbr-white pb-3 ">
                    <p class="mbr-text mbr-fonts-style display-5">
                        @if($user->id == Auth::user()->id && !$user->bio)  
                            ...
                            <a href="{{ route('frontend.user.edit') }}" class="btn btn-primary">Edit Profile</a>
                        @else
                    ...
                    <p style="padding:10px; background-color:; color:black;">
                        ...
                        <i style="color:gold;" class="fas fa-star"></i> Rating: {{ $average_rating ?? 0}}<br>
                    </p>
    ...
    <div class="container-fluid pt-5 pb-5 full-count-container counter">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h2 class="mbr-section-title mbr-fonts-style mbr-white display-2"><strong>Available for  </strong> {{ strtolower($next_available_date->service->name) }} with pets in</h2>
                </div>
                <div class="countdown-cont align-center col-lg-6">
                    ...
                    <div class="countdown" data-due-date="{{ $next_available_date->date_from }}"></div>
